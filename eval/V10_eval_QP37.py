...
num = 300
logger = get_logger('./eval/V10_QP37.log')
model_path1 = './YUV_model/OCT_QP37.pth'
model_path2 = './YUV_model/OCT_QP37.pth'
input1_path = './eval/Validation10/Validation10_QP37.yuv'#compressed
input2_path = './ISCAS_Grand_Challenge_Validation10.yuv'#
