...
num = 300
logger = get_logger('./eval/V10_QP27.log')
model_path1 = './YUV_model/OCT_QP27.pth'
model_path2 = './YUV_model/ab_QP27.pth'
input1_path = './eval/Validation10/Validation10_QP27.yuv'#compressed
