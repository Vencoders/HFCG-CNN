...
num = 300
logger = get_logger('./eval/V10_QP22.log')
model_path1 = './YUV_model/OCT_QP22.pth'
model_path2 = './YUV_model/ab_QP22.pth'
input1_path = './eval/Validation10/Validation10_QP22.yuv'#compressed
