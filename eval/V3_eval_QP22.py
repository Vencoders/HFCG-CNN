...
num = 300
logger = get_logger('./eval/V3_QP22.log')
model_path1 = './YUV_model/OCT_QP22.pth'
model_path2 = './YUV_model/QP22.pth'
input1_path = './eval/Validation3/Validation3_QP22.yuv'#compressed
input2_path = './ISCAS_Grand_Challenge_Validation3.yuv'#
